...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/epispot-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11785&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/epispot-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `epispot` can be installed with:

```
conda install epispot
```

It is possible to list all of the versions of `epispot` available on your platform with:
